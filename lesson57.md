...
```
4. Программа для проверки трёхзначности числа:
```Pascal
var x: integer;
begin
  write('Введите число: ');
...
5. Программа вывода времени года без использования оператора выбора:
```Pascal
var month: integer;
begin
...
6. Программа вывода времени года с использованием оператора выбора:
```Pascal
var month: integer;
begin
  writeln('Введите номер месяца: ');
...
7. Программа определения числа дней в месяце:
```Pascal
...
8. Программа определения количества дней до нового года:
```Pascal
...
9. Программа вывода возраста в правильной форме:
```Pascal
var age: integer;
begin
...
10. Программа для вывода числа прописью:
```Pascal
var x,n: integer; 
    s: string;
begin
